...
@section('content')
    ...
    <div class="grid" style="margin-top: 24px;">
        <div class="panel">
            ...
            @if($item->foto_masuk)
                <div class="photo-wrapper">
                    <img src="{{ route('absensi.photo', [$item, 'masuk']) }}" alt="Foto Masuk" loading="lazy" decoding="async">
                </div>
            @else
        ...
        <div class="panel">
            ...
            @if($item->foto_pulang)
                <div class="photo-wrapper">
                    <img src="{{ route('absensi.photo', [$item, 'pulang']) }}" alt="Foto Pulang" loading="lazy" decoding="async">
                </div>
            @else
