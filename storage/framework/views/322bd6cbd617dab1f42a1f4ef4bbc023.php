        ...
        <form method="POST" action="<?php echo e(route('admin.pengaturan.store')); ?>" enctype="multipart/form-data" class="settings-panel">
            ...
            <div class="settings-section">
                ...
                <div>
                    ...
                    <input id="app_name" type="text" name="app_name" maxlength="80" value="<?php echo e(old('app_name', $brandName)); ?>" required>
                </div>

                <div class="theme-options brand-options">
                    <label class="theme-option">
                        <input type="radio" name="app_brand_display" value="logo_name" <?php echo e($brandDisplay === 'logo_name' ? 'checked' : ''); ?>>
                        <span>Logo + Nama</span>
                    </label>

                    <label class="theme-option">
                        <input type="radio" name="app_brand_display" value="logo_only" <?php echo e($brandDisplay === 'logo_only' ? 'checked' : ''); ?>>
                        <span>Logo Saja</span>
                    </label>

                    <label class="theme-option">
                        <input type="radio" name="app_brand_display" value="name_only" <?php echo e($brandDisplay === 'name_only' ? 'checked' : ''); ?>>
                        <span>Nama Saja</span>
                    </label>
                </div>
...
unset($__errorArgs, $__bag); ?>
                <?php $__errorArgs = ['app_brand_display'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
