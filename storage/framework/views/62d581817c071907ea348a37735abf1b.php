...
<div class="dash-wrap">
    ...
    <div class="dash-header">
        <div>
            ...
            <div class="dash-header-sub">
                Selamat datang, <strong><?php echo e(auth()->user()->name ?? 'Petugas'); ?></strong> — Kelurahan <?php echo e(auth()->user()->tempat_tugas ?? ''); ?>
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            <div class="stat-card-top">
                <div class="stat-ico <?php echo e($statusClass['ico-bg']); ?>">
                    <?php if($statusClass['ico'] === 'check'): ?>
                    ...
                    <?php elseif($statusClass['ico'] === 'clock'): ?>
            ...
            <div class="stat-val <?php echo e($statusClass['val-c']); ?>" style="font-size:16px"><?php echo e($statusLabel); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-val c-accent" style="font-family:'DM Mono',monospace;font-size:20px">
                <?php echo e($absensiHariIni?->jam_masuk ?? '—'); ?>
        ...
        <div class="stat-card">
            ...
            <div class="stat-val c-green" style="font-family:'DM Mono',monospace;font-size:20px">
                <?php echo e($absensiHariIni?->jam_pulang ?? '—'); ?>
        ...
        <div class="stat-card">
            <div class="stat-card-top">
                <div class="stat-ico <?php echo e($notifikasiBelumBaca > 0 ? 'bg-red' : 'bg-green'); ?>">
                    <svg fill="none" viewBox="0 0 16 16">
                        <path d="M8 2a4.5 4.5 0 00-4.5 4.5v2.5L2 11h12l-1.5-2V6.5A4.5 4.5 0 008 2zM6.5 13a1.5 1.5 0 003 0"
                            stroke="<?php echo e($notifikasiBelumBaca > 0 ? '#EF4444' : '#10B981'); ?>"
                            stroke-width="1.3" stroke-linecap="round"/>
                    </svg>
                </div>
                <span class="notif-count <?php echo e($notifikasiBelumBaca > 0 ? 'has' : 'none'); ?>">
                    <?php echo e($notifikasiBelumBaca); ?>

                </span>
            </div>
            <div class="stat-lbl">Notifikasi belum dibaca</div>
            <div class="stat-val <?php echo e($notifikasiBelumBaca > 0 ? 'c-red' : 'c-green'); ?>">
                <?php echo e($notifikasiBelumBaca); ?>

            </div>
            <div class="stat-hint c-muted">
                <?php echo e($notifikasiBelumBaca > 0 ? 'perlu dibaca' : 'semua terbaca'); ?>
    ...
    <div class="panel-card">
        ...
        <div class="panel-body">
            <div class="quick-grid">
                <a href="<?php echo e(route('petugas.absensi.index')); ?>" class="quick-btn">
                ...
                <a href="<?php echo e(route('petugas.tugas.index')); ?>" class="quick-btn">
                ...
                <a href="<?php echo e(route('petugas.cuti.index')); ?>" class="quick-btn">
    ...
    <div class="panel-card">
        <div class="panel-head">
            ...
            <span style="font-size:11px;color:var(--text3)"><?php echo e($kalender->count()); ?> event</span>
        </div>
        <div class="panel-body">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $kalender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="kalender-item">
                        ...
                        <div class="kalender-info">
                            <div class="kalender-nama"><?php echo e($item->nama_event); ?></div>
                            <div class="kalender-tgl"><?php echo e($item->tanggal->format('d/m/Y')); ?></div>
                        </div>
                        <span class="kalender-badge"><?php echo e($item->jenis_event); ?></span>
                    </div>
