...
<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:10px;">
    <div>
        ...
        <p style="font-size:13px;color:var(--muted);margin:0;">
            Periode aktif: <strong style="color:var(--text-color);"><?php echo e($periodeAktif?->nama_periode ?? '-'); ?></strong>
        </p>
    </div>
</div>
...
<div class="abs-status-bar">
    <div class="abs-stat-card">
        ...
        <div>
            ...
            <span class="badge <?php echo e($today?->status ?? ''); ?>"><?php echo e($today?->status ?? 'belum absen'); ?></span>
        </div>
    </div>
    <div class="abs-stat-card">
        ...
        <div>
            ...
            <div class="abs-stat-value"><?php echo e($today?->jam_masuk ?? '--:--'); ?></div>
        </div>
    </div>
    <div class="abs-stat-card">
        ...
        <div>
            ...
            <div class="abs-stat-value"><?php echo e($today?->jam_pulang ?? '--:--'); ?></div>
        </div>
    </div>
    <div class="abs-stat-card">
...
<div class="abs-section">
    ...
    <form action="<?php echo e(route('petugas.absensi.index')); ?>" method="GET" class="abs-filter">
        ...
        <div class="abs-filter-actions">
            ...
            <a href="<?php echo e(route('petugas.absensi.index')); ?>" class="btn-f btn-f-reset">Reset</a>
            <a href="<?php echo e(route('petugas.absensi.print', request()->all())); ?>" target="_blank" class="btn-f btn-f-print">
        ...
        <table class="abs-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div class="abs-date-main"><?php echo e($item->tanggal->format('d/m/Y')); ?></div>
                            <div class="abs-date-sub"><?php echo e($item->tanggal->translatedFormat('l')); ?></div>
                        </td>
                        <td>
                            <?php if($item->jam_masuk): ?>
                                <span class="abs-time-masuk"><?php echo e($item->jam_masuk); ?></span>
                            <?php else: ?>
                        ...
                        <td>
                            <?php if($item->jam_pulang): ?>
                                <span class="abs-time-pulang"><?php echo e($item->jam_pulang); ?></span>
                            <?php else: ?>
                                <span class="abs-time-nil">—</span>
                            <?php endif; ?>
                        </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project_absensi\Absensi-app\resources\views/petugas/absensi.blade.php ENDPATH**/ ?>