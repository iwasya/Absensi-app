...
<main class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="welcome-sub">Masuk untuk mengakses <?php echo e($app_name); ?>.</div>
        ...
        <form method="POST" action="<?php echo e(route('login', [], false)); ?>">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input id="login" type="text" name="login" value="<?php echo e(old('login')); ?>" placeholder="Email atau username" required autofocus autocomplete="username">
                </div>
...
<?php /**PATH D:\Project_absensi\Absensi-app\resources\views/auth/login.blade.php ENDPATH**/ ?>