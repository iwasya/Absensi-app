...
<div class="admin-dash">
    <div class="dash-header">
        <div class="dash-title">
            ...
            <div class="dash-sub"><?php echo e(now()->translatedFormat('l, d F Y')); ?> - Ringkasan operasional aplikasi absensi</div>
        </div>
        <div class="dash-pill">
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($totalPetugas); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($totalAbsensiHariIni); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(($cutiPendingAdmin ?? 0) + ($approvalPulangPending ?? 0) + ($tugasPending ?? 0)); ?></div>
    ...
    <div class="content-grid">
        <div class="card-box">
            <div class="card-head">
                ...
                <a href="<?php echo e(route('admin.cuti.index')); ?>" class="card-link">Cek cuti</a>
            </div>
            <div class="card-body">
                <div class="queue-grid">
                    <div class="queue-item">
                        <div class="queue-row">
                            ...
                            <div class="queue-count" style="color:var(--red)"><?php echo e($cutiPending); ?></div>
                        </div>
                    ...
                    <div class="queue-item">
                        <div class="queue-row">
                            ...
                            <div class="queue-count" style="color:var(--amber)"><?php echo e($cutiPendingAdmin ?? 0); ?></div>
                        </div>
                    ...
                    <div class="queue-item">
                        <div class="queue-row">
                            ...
                            <div class="queue-count" style="color:var(--primary)"><?php echo e($approvalPulangPending ?? 0); ?></div>
                        </div>
                    ...
                    <div class="queue-item">
                        <div class="queue-row">
                            ...
                            <div class="queue-count" style="color:#6366F1"><?php echo e($tugasPending); ?></div>
                        </div>
        ...
        <div class="card-box">
            <div class="card-head">
                ...
                <a href="<?php echo e(route('admin.periode.index')); ?>" class="card-link">Kelola</a>
            </div>
            <div class="card-body">
                <div class="period-box">
                    <div class="period-main">
                        <div class="period-label">Periode berjalan</div>
                        <div class="period-name"><?php echo e($periodeAktif?->nama_periode ?? 'Belum ada periode aktif'); ?></div>
                        <div class="period-meta">Digunakan sebagai acuan absensi, cuti, dan laporan tugas.</div>
                    </div>
                    <a class="quick-link" href="<?php echo e(route('admin.buka-absen.index')); ?>">
    ...
    <div class="card-box">
        <div class="card-head">
            ...
            <a href="<?php echo e(route('admin.logs.index')); ?>" class="card-link">Log aktivitas</a>
        </div>
        <div class="card-body">
            <div class="quick-grid">
                <a class="quick-link" href="<?php echo e(route('admin.users.index')); ?>">
                ...
                <a class="quick-link" href="<?php echo e(route('admin.tempat.index')); ?>">
                ...
                <a class="quick-link" href="<?php echo e(route('admin.kalender.index')); ?>">
                ...
                <a class="quick-link" href="<?php echo e(route('admin.cuti.index')); ?>">
                ...
                <a class="quick-link" href="<?php echo e(route('admin.sift.index')); ?>">
                ...
                <a class="quick-link" href="<?php echo e(route('admin.pengaturan.index')); ?>">
